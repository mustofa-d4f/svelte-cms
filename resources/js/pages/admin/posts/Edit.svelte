...
<script lang="ts">
    ...
    let { post, categories, tags }: { post: any; categories: any[]; tags: any[] } = $props();
    ...
    let form = useForm(initialData);

    function submit(e: Event) {
        e.preventDefault();
        form.put(update.url(post.id));
    }
                ...
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        <div class="space-y-2">
                            ...
                            <Input id="title" bind:value={form.title} placeholder="Judul artikel" />
